...
class tableAttlec extends StatefulWidget {
  const tableAttlec({super.key});

  @override
  State<tableAttlec> createState() => _tableAttlecState();
}

class _tableAttlecState extends State<tableAttlec> {
  @override
            ...
            return SingleChildScrollView(
              ...
              child: SingleChildScrollView(
                ...
                child: DataTable(
                  ...
                  rows: state.LECattendence.attendanceArray!.map((attendance) {
                    return DataRow(
                      cells: [
